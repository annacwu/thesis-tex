...
Our results show that the \textsc{wt} algorithm is an effective potential solution
...
testing \textsc{wt} in an additional experimental setting with preferences
reported by real students would be helpful for confirming whether it is ready to
be implemented as an actual mechanism at Reed.
