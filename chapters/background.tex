...
\begin{figure}[H] \centering
  \includegraphics[width=0.6\linewidth]{figures/graph.jpeg}\caption{Simple graph with 6
...
\cite{graphs}. \setlength{\belowcaptionskip}{-10pt} \begin{figure}[H] \centering
  \includegraphics[width=0.7\linewidth]{figures/graph-color.jpeg}\caption{Graph from
...
\begin{figure}[H] \centering
\includegraphics[width=0.7\linewidth]{figures/weighted-graph.jpeg}\caption{Graph from
...
\begin{figure}[H] \centering
\includegraphics[width=0.9\linewidth]{figures/stable-marriage.jpeg}\caption{Bipartite
...
\begin{figure}[H] \centering
\includegraphics[width=0.9\linewidth]{figures/cake-cutting.jpeg}\caption{cake cutting
