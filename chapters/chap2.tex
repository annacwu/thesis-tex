...
students, $S$, and a set of HUM class sections, each of which have a certain
number of seats. We will call the set of all seats $C$. Though we are working in
a bipartite setting, only one side of our market has preference over the other
...
illustrating generic model} \label{fig:placeholder} \end{figure}\section{The
...
\begin{proof} Let $C = \{ c_1, c_2\}$, where there are two types of student
  ...
  follows: \[ \begin{array}{ll} A1: & c_1 \\ B1: & c_2 \\ A2: & c_1 \succ c_2\\
  B2: & c_2 \succ c_1\end{array} \]
