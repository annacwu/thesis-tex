...
is specific to the school and the first-years in particular: Humanities 110.
...
The course serves as a foundation for every student's course of study at Reed;
as part of that, it should foster an
environment where students are surrounded by other students with a variety of
academic interests, from language and literature to
social sciences to hard sciences to arts. So, we have developed an algorithm that
